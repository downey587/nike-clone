...
function FiltersButton( { resultsNumber } ) {
    return (
        <div className="w-full h-14 flex justify-between items-center px-5">
            ...
            <button className="w-28 h-8 text-base font-semibold flex border border-gray-300 rounded-2xl justify-center items-center">
